...
class HillClimbingStart(Optimizer):
    def __init__(
        self,
        ...
        self.swaps = self.params.get("swaps", 1)

    def optimize(self, start_mask: Solution) -> Tuple[float, Solution]:
        ...
        pbar = tqdm(range(self.steps_per_restart - 1))
        for _ in pbar:
